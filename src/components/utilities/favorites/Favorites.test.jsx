describe('Favorites', () => {
  ...
  test.todo('No favorites are shown when data cannot be retrieved from local storage');

  test.todo('Country rows render after query returns data and inlcudes a link to the country details');
});
